...
--Q1.Write a query to find the top 5 most frequently ordered dishes by the customer "Arjun Mehta" in last 1 year.
...
-- Popular Time Slots
-- Q.2 Identify the time slots during which the most orders are placed, based on 2-hour intervals
